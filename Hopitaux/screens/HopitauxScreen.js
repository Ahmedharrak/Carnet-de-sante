...
class HopitauxScreen extends Component {

  constructor() {
    super();
    this.firestoreRef = firebase.firestore().collection('Hopitaux').orderBy("location");
    this.state = {
      isLoading: true,
      hopitauxArr: [],
            ...
            this.state.hopitauxArr.map((item, i) => {
              return (
                <ListItem
                  ...
                  onPress={() => {
                    this.props.navigation.navigate('HopitauxDetailScreen', {
