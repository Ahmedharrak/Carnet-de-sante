...
class FavorisSDetailScreen extends Component {
  ...
  componentDidMount() {
    const dbRef = firebase.firestore().collection('FavorisS').doc(this.props.route.params.serviceskey)
    dbRef.get().then((res) => {
      if (res.exists) {
    ...
    return (
      ...
      <ScrollView style={styles.container}>
        ...
        <Text style={{ 
          ...
          <TextInput
          style={{ marginLeft:30,fontSize: 14,color : "white",marginBottom:20 }}
              placeholder={'Mobile'}
...
export default FavorisSDetailScreen;