...
class FavorisSScreen extends Component {

  constructor() {
    super();
    this.firestoreRef = firebase.firestore().collection('FavorisS').orderBy("location");
    this.state = {
      isLoading: true,
      servicesArr: [],
            ...
            this.state.servicesArr.map((item, i) => {
              return (
                ...
                <ListItem
                  ...
                  onPress={() => {
                    this.props.navigation.navigate('FavorisSDetailScreen', {
