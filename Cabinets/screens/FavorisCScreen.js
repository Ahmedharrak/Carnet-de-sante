...
class FavorisCScreen extends Component {

  constructor() {
    super();
    this.firestoreRef = firebase.firestore().collection('FavorisC').orderBy("location");
    this.state = {
      isLoading: true,
      cabinetsArr: [],
            ...
            this.state.cabinetsArr.map((item, i) => {
              return (
                ...
                <ListItem
                  ...
                  onPress={() => {
                    this.props.navigation.navigate('FavorisCDetailScreen', {
